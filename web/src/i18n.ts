...
const MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.keySelection.title": "Key Selection Strategy",
    "settings.keySelection.description":
      "Choose whether the proxy should keep draining one key first or spread traffic toward keys with more remaining quota.",
    "settings.keySelection.policy": "Strategy",
    "settings.keySelection.fillFirst": "Fill-first (sticky)",
    "settings.keySelection.balance": "Balance by remaining quota",
    "settings.keySelection.save": "Save Selection Strategy",
    "settings.upstreamProxy.title": "Upstream Proxy",
    "settings.upstreamProxy.description":
      "Configure a global outbound proxy for Tavily upstream traffic. Supports http:// and socks5:// URLs with optional credentials. MCP calls and quota sync requests use the same setting.",
    "settings.upstreamProxy.enabled": "Enable Upstream Proxy",
    "settings.upstreamProxy.proxyUrl": "Proxy URL",
    "settings.upstreamProxy.placeholder":
      "e.g. http://127.0.0.1:7890 or socks5://127.0.0.1:1080",
    "settings.upstreamProxy.save": "Save Proxy Configuration",
    ...
    "settings.errors.loadKeySelection": "Failed to load key selection settings",
    "settings.errors.loadUpstreamProxy": "Failed to load upstream proxy settings",
  ...
  "zh-CN": {
    ...
    "settings.keySelection.title": "Key 调度策略",
    "settings.keySelection.description":
      "可选择优先持续消耗同一把 key，或按剩余额度更均衡地分配请求。",
    "settings.keySelection.policy": "调度策略",
    "settings.keySelection.fillFirst": "fill-first（先打满一把）",
    "settings.keySelection.balance": "余额优先（均衡）",
    "settings.keySelection.save": "保存调度策略",
    "settings.upstreamProxy.title": "上游代理",
    "settings.upstreamProxy.description":
      "为 Tavily 上游流量配置统一出站代理。支持带可选账号密码的 http:// 与 socks5:// URL；MCP 调用和额度同步也会复用这项设置。",
    "settings.upstreamProxy.enabled": "启用上游代理",
    "settings.upstreamProxy.proxyUrl": "代理地址",
    "settings.upstreamProxy.placeholder":
      "例如 http://127.0.0.1:7890 或 socks5://127.0.0.1:1080",
    "settings.upstreamProxy.save": "保存代理配置",
    ...
    "settings.errors.loadKeySelection": "Key 调度策略加载失败",
    "settings.errors.loadUpstreamProxy": "上游代理设置加载失败",
